...
// IMPLEMENTING PAGE NAVIGATION BY EVENT DELEGATION
...
//sticky navigation by API INTERSECTIONOBSERVER

const headerCall = function (entries) {
  const [entry] = entries;
...
const headerObserver = new IntersectionObserver(headerCall, headerOpt);
